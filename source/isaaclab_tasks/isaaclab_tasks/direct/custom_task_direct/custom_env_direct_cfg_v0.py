...
with open("./robot_files.yaml") as f:
    asset_paths = yaml.safe_load(f)
...
class UR5eRG2CustomTableEnvCfg(DirectRLEnvCfg):
    ...
    object1 = RigidObjectCfg(
        prim_path=asset_paths["objects"]["obj_1"]["prim"],
        init_state=RigidObjectCfg.InitialStateCfg(pos=(0.3, 0.2, 0.815), 
                                                  rot=(1.0, 0.0, 0.0, 0.0)),
        spawn=UsdFileCfg(
            usd_path=asset_paths["objects"]["obj_1"]["path"],
            scale=(0.1, 0.1, 0.1),
    ...
    object2 = RigidObjectCfg(
        prim_path=asset_paths["objects"]["obj_2"]["prim"],
        init_state=RigidObjectCfg.InitialStateCfg(pos=(0.3, 0.3, 0.815), 
                                                  rot=(1.0, 0.0, 0.0, 0.0)),
        spawn=UsdFileCfg(
            usd_path=asset_paths["objects"]["obj_2"]["path"],
            scale=(0.1, 0.1, 0.1),
            rigid_props=RigidBodyPropertiesCfg(
                solver_position_iteration_count=16,
                solver_velocity_iteration_count=1,
    ...
    object3 = RigidObjectCfg(
        prim_path=asset_paths["objects"]["obj_3"]["prim"],
        init_state=RigidObjectCfg.InitialStateCfg(pos=(0.3, 0.4, 0.815), 
                                                  rot=(1.0, 0.0, 0.0, 0.0)),
        spawn=UsdFileCfg(
            usd_path=asset_paths["objects"]["obj_3"]["path"],
            scale=(0.1, 0.1, 0.1),
            rigid_props=RigidBodyPropertiesCfg(
                solver_position_iteration_count=16,
                solver_velocity_iteration_count=1,
